...
public class CameraRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        GLES20.glBindTexture(36197, textureId); // 36197 to GL_TEXTURE_EXTERNAL_OES
        GLES20.glTexParameterf(36197, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_NEAREST);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (isMirrored) {
            // Matematyka: Żeby odbić teksturę horyzontalnie (0..1 -> 1..0),
            // musimy ją przesunąć i przeskalować.
            // Kolejność w OpenGL jest odwrotna do intuicji (stos).

            // Przesuwamy o 1.0 w osi X
            android.opengl.Matrix.translateM(vPMatrix, 0, 1.0f, 0.0f, 0.0f);
            // Skalujemy oś X przez -1.0
        ...
        GLES20.glUniform1i(GLES20.glGetUniformLocation(programId, "sLutTexture"), 1);
